...
<title>CovidSupport - Fight Together | Submit NGOs/ Help Providers Details</title>
...
<div class="container">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="about.html"><img src="images/Covidsupportlogo1.jpeg" alt="CovidSupport" />FIGHT <span>TOGETHER</span></a>
    </div>
    <div class="navbar-collapse collapse">
        ...
        <ul class="userButtons">  
            ...
            <li class="userBtn"><a href="login.html" class="buttonGrey">REGISTER</a></li>
        </ul>
        <!-- end login/register -->
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown menu-item-has-children">
                <a href="listing_helpprovider_NGO.html">NGOs/ Help Providers</a>
            </li>
            <li class="dropdown menu-item-has-children">
                <a href="listing_patients.html">Patients List</a>
            </li>
        </ul>      
    </div><!--/.navbar-collapse -->
...
<section class="subHeader page">
    <div class="container">
        <h1>Submit NGOs/ Help Providers Details</h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-4">
                <h3>NGOs/ HELP PROVIDERS INFORMATION</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-6">
                                ...
                                <select name="state" id="state" class="formDropdown">
                                    ...
                                    <option value="DD">Dadra and Nagar Haveliand Daman and Diu</option>
            ...
            <div class="col-lg-4 col-lg-offset-4 col-md-4">
                <div class="formBlock">
                    <input class="buttonColor" type="submit" value="UPDATE">
                </div>
            </div>
