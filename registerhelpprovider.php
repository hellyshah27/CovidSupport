...
<section class="subHeader page">
    <div class="container">
    	<h1>Register Now to help Covid Patients!</h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-lg-offset-4">
                <h3>REGISTRATION for Help Providers/ NGOs</h3>
                ...
                <div class="filterContent defaultTab sidebarWidget">
                    <form method="post" action="connectNGO.php">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-6">
                                <div class="formBlock"> 
                                <label for="patient">Help Provider</label><input type="radio" id="patient" name="helpprovider" value="patient">
                                <label for="NGO">NGO</label><input type="radio" id="NGO" name="NGO" value="NGO">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-6">
                                <div class="formBlock">
